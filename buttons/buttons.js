...
function prev() {
    ...
    document.getElementById("description").textContent = products[currentIndex].description;
...
window.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById("description").textContent = products[0].description;
    document.getElementById("price").textContent = `$. ${products[currentIndex].price}`;
